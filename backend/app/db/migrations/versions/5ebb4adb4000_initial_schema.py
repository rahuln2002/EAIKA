...
Revision ID: 5ebb4adb4000
Revises:
Create Date: 2026-06-27 06:00:32.728349
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("retrieval_latency", sa.Float(), nullable=True),
        sa.Column("history_latency", sa.Float(), nullable=True),
        sa.Column("llm_latency", sa.Float(), nullable=True),
    ...
    op.create_index(
        op.f("ix_analytics_user_id"), "analytics", ["user_id"], unique=False
    )
    op.create_table(
        "chats",
        sa.Column("id", sa.Integer(), nullable=False),
